...
{
  QByteArray textUtf8 = text.toUtf8();
  send(SCI_CHANGEINSERTION, (uptr_t)textUtf8.length(), (sptr_t)textUtf8.constData());
}

void ScintillaIFace::clearAll()
{
...
int ScintillaIFace::length() const
{
  return (int)send(SCI_GETLENGTH, 0, 0);
}
...
int ScintillaIFace::anchor() const
{
  return (int)send(SCI_GETANCHOR, 0, 0);
}
...
void ScintillaIFace::selectAll()
{
  send(SCI_SELECTALL, 0, 0);
}

void ScintillaIFace::setSavePoint()
{
...
bool ScintillaIFace::canRedo()
{
  return send(SCI_CANREDO, 0, 0) != 0;
}
...
int ScintillaIFace::viewWS() const
{
  return (int)send(SCI_GETVIEWWS, 0, 0);
}
...
void ScintillaIFace::gotoLine(int line)
{
  send(SCI_GOTOLINE, (uptr_t)line, 0);
}

void ScintillaIFace::gotoPos(int pos)
{
  send(SCI_GOTOPOS, (uptr_t)pos, 0);
}
...
int ScintillaIFace::eOLMode() const
{
  return (int)send(SCI_GETEOLMODE, 0, 0);
}
...
int ScintillaIFace::markers(int line)
{
...
void ScintillaIFace::styleClearAll()
{
...
void ScintillaIFace::styleResetDefault()
{
...
void ScintillaIFace::clearAllCmdKeys()
{
...
void ScintillaIFace::beginUndoAction()
{
  send(SCI_BEGINUNDOACTION, 0, 0);
}

void ScintillaIFace::endUndoAction()
{
...
void ScintillaIFace::autoCCancel()
{
  send(SCI_AUTOCCANCEL, 0, 0);
}

bool ScintillaIFace::autoCActive()
{
  return send(SCI_AUTOCACTIVE, 0, 0) != 0;
}
...
void ScintillaIFace::autoCComplete()
{
...
int ScintillaIFace::indent() const
{
  return (int)send(SCI_GETINDENT, 0, 0);
}
...
bool ScintillaIFace::useTabs() const
{
  return send(SCI_GETUSETABS, 0, 0) != 0;
}
...
int ScintillaIFace::column(int pos) const
{
  return send(SCI_GETCOLUMN, pos);
}
...
QPair<int,int> ScintillaIFace::findText(int flags, const char *text, int min, int max)
{
...
void ScintillaIFace::scrollCaret()
{
...
void ScintillaIFace::null()
{
  send(SCI_NULL, 0, 0);
}

bool ScintillaIFace::canPaste()
{
  return send(SCI_CANPASTE, 0, 0) != 0;
}

bool ScintillaIFace::canUndo()
{
  return send(SCI_CANUNDO, 0, 0) != 0;
}

void ScintillaIFace::emptyUndoBuffer()
{
  send(SCI_EMPTYUNDOBUFFER, 0, 0);
}

void ScintillaIFace::undo()
{
  send(SCI_UNDO, 0, 0);
}

void ScintillaIFace::cut()
{
  send(SCI_CUT, 0, 0);
}

void ScintillaIFace::copy()
{
  send(SCI_COPY, 0, 0);
}

void ScintillaIFace::paste()
{
  send(SCI_PASTE, 0, 0);
}

void ScintillaIFace::clear()
{
  send(SCI_CLEAR, 0, 0);
}
...
{
  QByteArray textUtf8 = text.toUtf8();
  return (int)send(SCI_REPLACETARGET, (uptr_t)textUtf8.length(), (sptr_t)textUtf8.constData());
}

int ScintillaIFace::replaceTargetRE(const QString & text)
{
  QByteArray textUtf8 = text.toUtf8();
  return (int)send(SCI_REPLACETARGETRE, (uptr_t)textUtf8.length(), (sptr_t)textUtf8.constData());
}

int ScintillaIFace::searchInTarget(const QString & text)
{
  QByteArray textUtf8 = text.toUtf8();
  return (int)send(SCI_SEARCHINTARGET, (uptr_t)textUtf8.length(), (sptr_t)textUtf8.constData());
}
...
void ScintillaIFace::callTipCancel()
{
...
{
  return (int)send(SCI_WORDSTARTPOSITION, (uptr_t)pos, (sptr_t)onlyWordCharacters);
}

int ScintillaIFace::wordEndPosition(int pos, bool onlyWordCharacters) const
{
  return (int)send(SCI_WORDENDPOSITION, (uptr_t)pos, (sptr_t)onlyWordCharacters);
}
...
void ScintillaIFace::lineDown()
{
  send(SCI_LINEDOWN, 0, 0);
}

void ScintillaIFace::lineDownExtend()
{
  send(SCI_LINEDOWNEXTEND, 0, 0);
}

void ScintillaIFace::lineUp()
{
  send(SCI_LINEUP, 0, 0);
}

void ScintillaIFace::lineUpExtend()
{
  send(SCI_LINEUPEXTEND, 0, 0);
}

void ScintillaIFace::charLeft()
{
  send(SCI_CHARLEFT, 0, 0);
}

void ScintillaIFace::charLeftExtend()
{
  send(SCI_CHARLEFTEXTEND, 0, 0);
}

void ScintillaIFace::charRight()
{
  send(SCI_CHARRIGHT, 0, 0);
}

void ScintillaIFace::charRightExtend()
{
  send(SCI_CHARRIGHTEXTEND, 0, 0);
}

void ScintillaIFace::wordLeft()
{
  send(SCI_WORDLEFT, 0, 0);
}

void ScintillaIFace::wordLeftExtend()
{
  send(SCI_WORDLEFTEXTEND, 0, 0);
}

void ScintillaIFace::wordRight()
{
  send(SCI_WORDRIGHT, 0, 0);
}

void ScintillaIFace::wordRightExtend()
{
  send(SCI_WORDRIGHTEXTEND, 0, 0);
}

void ScintillaIFace::home()
{
  send(SCI_HOME, 0, 0);
}

void ScintillaIFace::homeExtend()
{
  send(SCI_HOMEEXTEND, 0, 0);
}

void ScintillaIFace::lineEnd()
{
  send(SCI_LINEEND, 0, 0);
}

void ScintillaIFace::lineEndExtend()
{
  send(SCI_LINEENDEXTEND, 0, 0);
}

void ScintillaIFace::documentStart()
{
...
void ScintillaIFace::documentEnd()
{
  send(SCI_DOCUMENTEND, 0, 0);
}

void ScintillaIFace::documentEndExtend()
{
  send(SCI_DOCUMENTENDEXTEND, 0, 0);
}

void ScintillaIFace::pageUp()
{
  send(SCI_PAGEUP, 0, 0);
}

void ScintillaIFace::pageUpExtend()
{
  send(SCI_PAGEUPEXTEND, 0, 0);
}

void ScintillaIFace::pageDown()
{
  send(SCI_PAGEDOWN, 0, 0);
}

void ScintillaIFace::pageDownExtend()
{
...
void ScintillaIFace::cancel()
{
  send(SCI_CANCEL, 0, 0);
}

void ScintillaIFace::deleteBack()
{
  send(SCI_DELETEBACK, 0, 0);
}

void ScintillaIFace::tab()
{
  send(SCI_TAB, 0, 0);
}

void ScintillaIFace::backTab()
{
  send(SCI_BACKTAB, 0, 0);
}

void ScintillaIFace::newLine()
{
  send(SCI_NEWLINE, 0, 0);
}

void ScintillaIFace::formFeed()
{
  send(SCI_FORMFEED, 0, 0);
}

void ScintillaIFace::vCHome()
{
  send(SCI_VCHOME, 0, 0);
}

void ScintillaIFace::vCHomeExtend()
{
  send(SCI_VCHOMEEXTEND, 0, 0);
}

void ScintillaIFace::zoomIn()
{
  send(SCI_ZOOMIN, 0, 0);
}

void ScintillaIFace::zoomOut()
{
  send(SCI_ZOOMOUT, 0, 0);
}

void ScintillaIFace::delWordLeft()
{
  send(SCI_DELWORDLEFT, 0, 0);
}

void ScintillaIFace::delWordRight()
{
  send(SCI_DELWORDRIGHT, 0, 0);
}

void ScintillaIFace::delWordRightEnd()
{
  send(SCI_DELWORDRIGHTEND, 0, 0);
}

void ScintillaIFace::lineCut()
{
  send(SCI_LINECUT, 0, 0);
}

void ScintillaIFace::lineDelete()
{
  send(SCI_LINEDELETE, 0, 0);
}

void ScintillaIFace::lineTranspose()
{
  send(SCI_LINETRANSPOSE, 0, 0);
}

void ScintillaIFace::lineDuplicate()
{
  send(SCI_LINEDUPLICATE, 0, 0);
}

void ScintillaIFace::lowerCase()
{
  send(SCI_LOWERCASE, 0, 0);
}

void ScintillaIFace::upperCase()
{
  send(SCI_UPPERCASE, 0, 0);
}

void ScintillaIFace::lineScrollDown()
{
  send(SCI_LINESCROLLDOWN, 0, 0);
}

void ScintillaIFace::lineScrollUp()
{
  send(SCI_LINESCROLLUP, 0, 0);
}

void ScintillaIFace::deleteBackNotLine()
{
  send(SCI_DELETEBACKNOTLINE, 0, 0);
}

void ScintillaIFace::homeDisplay()
{
  send(SCI_HOMEDISPLAY, 0, 0);
}

void ScintillaIFace::homeDisplayExtend()
{
  send(SCI_HOMEDISPLAYEXTEND, 0, 0);
}

void ScintillaIFace::lineEndDisplay()
{
...
void ScintillaIFace::homeWrap()
{
  send(SCI_HOMEWRAP, 0, 0);
}

void ScintillaIFace::homeWrapExtend()
{
  send(SCI_HOMEWRAPEXTEND, 0, 0);
}

void ScintillaIFace::lineEndWrap()
{
  send(SCI_LINEENDWRAP, 0, 0);
}

void ScintillaIFace::lineEndWrapExtend()
{
  send(SCI_LINEENDWRAPEXTEND, 0, 0);
}

void ScintillaIFace::vCHomeWrap()
{
  send(SCI_VCHOMEWRAP, 0, 0);
}

void ScintillaIFace::vCHomeWrapExtend()
{
  send(SCI_VCHOMEWRAPEXTEND, 0, 0);
}

void ScintillaIFace::lineCopy()
{
...
void ScintillaIFace::braceHighlightIndicator(bool useBraceHighlightIndicator, int indicator)
{
  send(SCI_BRACEHIGHLIGHTINDICATOR, (uptr_t)useBraceHighlightIndicator, (sptr_t)indicator);
}
...
void ScintillaIFace::braceBadLightIndicator(bool useBraceBadLightIndicator, int indicator)
{
  send(SCI_BRACEBADLIGHTINDICATOR, (uptr_t)useBraceBadLightIndicator, (sptr_t)indicator);
}
...
bool ScintillaIFace::viewEOL() const
{
  return send(SCI_GETVIEWEOL, 0, 0) != 0;
}
...
void ScintillaIFace::searchAnchor()
{
...
void ScintillaIFace::setZoom(int zoom)
{
  send(SCI_SETZOOM, (uptr_t)zoom, 0);
}

int ScintillaIFace::zoom() const
{
  return (int)send(SCI_GETZOOM, 0, 0);
}
...
bool ScintillaIFace::focus() const
{
  return send(SCI_GETFOCUS, 0, 0) != 0;
}
...
int ScintillaIFace::status() const
{
  return (int)send(SCI_GETSTATUS, 0, 0);
}
...
int ScintillaIFace::cursor() const
{
  return (int)send(SCI_GETCURSOR, 0, 0);
}
...
void ScintillaIFace::wordPartLeft()
{
...
void ScintillaIFace::wordPartRight()
{
...
void ScintillaIFace::delLineLeft()
{
  send(SCI_DELLINELEFT, 0, 0);
}

void ScintillaIFace::delLineRight()
{
...
int ScintillaIFace::xOffset() const
{
  return (int)send(SCI_GETXOFFSET, 0, 0);
}

void ScintillaIFace::chooseCaretX()
{
  send(SCI_CHOOSECARETX, 0, 0);
}

void ScintillaIFace::grabFocus()
{
...
void ScintillaIFace::paraDown()
{
  send(SCI_PARADOWN, 0, 0);
}

void ScintillaIFace::paraDownExtend()
{
  send(SCI_PARADOWNEXTEND, 0, 0);
}

void ScintillaIFace::paraUp()
{
  send(SCI_PARAUP, 0, 0);
}

void ScintillaIFace::paraUpExtend()
{
...
void ScintillaIFace::lineUpRectExtend()
{
...
void ScintillaIFace::homeRectExtend()
{
  send(SCI_HOMERECTEXTEND, 0, 0);
}

void ScintillaIFace::vCHomeRectExtend()
{
  send(SCI_VCHOMERECTEXTEND, 0, 0);
}

void ScintillaIFace::lineEndRectExtend()
{
  send(SCI_LINEENDRECTEXTEND, 0, 0);
}

void ScintillaIFace::pageUpRectExtend()
{
...
void ScintillaIFace::stutteredPageUp()
{
...
void ScintillaIFace::stutteredPageDown()
{
...
void ScintillaIFace::wordLeftEnd()
{
  send(SCI_WORDLEFTEND, 0, 0);
}

void ScintillaIFace::wordLeftEndExtend()
{
  send(SCI_WORDLEFTENDEXTEND, 0, 0);
}

void ScintillaIFace::wordRightEnd()
{
...
void ScintillaIFace::setCharsDefault()
{
...
void ScintillaIFace::toggleCaretSticky()
{
...
void ScintillaIFace::copyAllowLine()
{
...
void ScintillaIFace::annotationClearAll()
{
...
void ScintillaIFace::setMouseSelectionRectangularSwitch(bool mouseSelectionRectangularSwitch)
{
  send(SCI_SETMOUSESELECTIONRECTANGULARSWITCH, (uptr_t)mouseSelectionRectangularSwitch, 0);
}
...
void ScintillaIFace::setAdditionalSelectionTyping(bool additionalSelectionTyping)
{
...
void ScintillaIFace::clearSelections()
{
...
void ScintillaIFace::rotateSelection()
{
...
void ScintillaIFace::scrollToStart()
{
  send(SCI_SCROLLTOSTART, 0, 0);
}

void ScintillaIFace::scrollToEnd()
{
...
void ScintillaIFace::findIndicatorHide()
{
  send(SCI_FINDINDICATORHIDE, 0, 0);
}

void ScintillaIFace::vCHomeDisplay()
{
...
void ScintillaIFace::setRepresentation(const QString & encodedCharacter, const QString & representation)
{
  QByteArray encodedCharacterUtf8 = encodedCharacter.toUtf8();
  QByteArray representationUtf8 = representation.toUtf8();
  send(SCI_SETREPRESENTATION, (uptr_t)encodedCharacterUtf8.constData(), (sptr_t)representationUtf8.constData());
}

int ScintillaIFace::representation(const QString & encodedCharacter, char * representation) const
{
  QByteArray encodedCharacterUtf8 = encodedCharacter.toUtf8();
  return (int)send(SCI_GETREPRESENTATION, (uptr_t)encodedCharacterUtf8.constData(), (sptr_t)representation);
}
...
void ScintillaIFace::startRecord()
{
  send(SCI_STARTRECORD, 0, 0);
}

void ScintillaIFace::stopRecord()
{
...
int ScintillaIFace::lexer() const
{
  return (int)send(SCI_GETLEXER, 0, 0);
}
...
void ScintillaIFace::setProperty(const QString & key, const QString & value)
{
  ...
  send(SCI_SETPROPERTY, (uptr_t)keyUtf8.constData(), (sptr_t)valueUtf8.constData());
}
...
{
  QByteArray keyUtf8 = key.toUtf8();
  return (int)send(SCI_GETPROPERTYEXPANDED, (uptr_t)keyUtf8.constData(), (sptr_t)buf);
}
...
{
  QByteArray nameUtf8 = name.toUtf8();
  return (int)send(SCI_DESCRIBEPROPERTY, (uptr_t)nameUtf8.constData(), (sptr_t)description);
}
...
{
  return (int)send(SCI_ALLOCATESUBSTYLES, (uptr_t)styleBase, (sptr_t)numberStyles);
}
...
void ScintillaIFace::freeSubStyles()
{
