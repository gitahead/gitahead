  ...
  : QAbstractTableModel(parent), mRepo(repo)
{
  ...
  connect(notifier, &git::RepositoryNotifier::remoteAboutToBeAdded,
          this, &RemoteTableModel::beginResetModel);
  connect(notifier, &git::RepositoryNotifier::remoteAdded,
          this, &RemoteTableModel::endResetModel);
  connect(notifier, &git::RepositoryNotifier::remoteAboutToBeRemoved,
          this, &RemoteTableModel::beginResetModel);
  connect(notifier, &git::RepositoryNotifier::remoteRemoved,
          this, &RemoteTableModel::endResetModel);
}
...
QVariant RemoteTableModel::headerData(
  int section,
