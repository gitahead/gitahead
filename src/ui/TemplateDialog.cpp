...
TemplateDialog::TemplateDialog(QList<TemplateButton::Template> &templates, QWidget* parent) :
    QDialog(parent),
    ...
    mNew(templates)
{
    ...
    connect(mRemove, &QPushButton::pressed, this, &TemplateDialog::removeTemplate);
    connect(mUp, &QPushButton::pressed, this, &TemplateDialog::moveTemplateUp);
    connect(mDown, &QPushButton::pressed, this, &TemplateDialog::moveTemplateDown);
    connect(mButtonBox, &QDialogButtonBox::accepted, this, &TemplateDialog::applyTemplates);
    connect(mButtonBox, &QDialogButtonBox::rejected, this, &TemplateDialog::reject);
    connect(mName, &QLineEdit::textChanged, this, &TemplateDialog::checkName);
    connect(mTemplateList, &QListWidget::currentRowChanged, this, &TemplateDialog::showTemplate);
