...
private:
  ...
  bool firstEntry;
  void copyEachEntry(LogView * logView, QList<QAbstractScrollArea *> qTextEdits, int entries);
};
...
void TestLog::copy()
{
  ...
  QList<QAbstractScrollArea *> qTextEdits = mSplitter->findChildren<QAbstractScrollArea *>();
...
void  TestLog::copyEachEntry(LogView *logView, QList<QAbstractScrollArea *> qTextEdits, int entries) {
  if(firstEntry){
