...
void ScintillaEdit::deleteRange(sptr_t pos, sptr_t deleteLength) {
...
sptr_t ScintillaEdit::markerLineFromHandle(sptr_t handle) {
    return send(SCI_MARKERLINEFROMHANDLE, handle, 0);
}

void ScintillaEdit::markerDeleteHandle(sptr_t handle) {
...
void ScintillaEdit::gotoPos(sptr_t pos) {
    send(SCI_GOTOPOS, pos, 0);
}

void ScintillaEdit::setAnchor(sptr_t posAnchor) {
...
void ScintillaEdit::startStyling(sptr_t pos, sptr_t mask) {
...
void ScintillaEdit::markerAddSet(sptr_t line, sptr_t set) {
...
void ScintillaEdit::styleSetEOLFilled(sptr_t style, bool filled) {
...
void ScintillaEdit::styleSetCase(sptr_t style, sptr_t caseForce) {
    send(SCI_STYLESETCASE, style, caseForce);
}

void ScintillaEdit::styleSetSizeFractional(sptr_t style, sptr_t caseForce) {
...
void ScintillaEdit::assignCmdKey(sptr_t km, sptr_t msg) {
    send(SCI_ASSIGNCMDKEY, km, msg);
}

void ScintillaEdit::clearCmdKey(sptr_t km) {
...
void ScintillaEdit::indicSetStyle(sptr_t indic, sptr_t style) {
    send(SCI_INDICSETSTYLE, indic, style);
}

sptr_t ScintillaEdit::indicStyle(sptr_t indic) const {
    return send(SCI_INDICGETSTYLE, indic, 0);
}

void ScintillaEdit::indicSetFore(sptr_t indic, sptr_t fore) {
    send(SCI_INDICSETFORE, indic, fore);
}

sptr_t ScintillaEdit::indicFore(sptr_t indic) const {
    return send(SCI_INDICGETFORE, indic, 0);
}

void ScintillaEdit::indicSetUnder(sptr_t indic, bool under) {
...
void ScintillaEdit::autoCShow(sptr_t lenEntered, const char * itemList) {
...
void ScintillaEdit::setLineIndentation(sptr_t line, sptr_t indentSize) {
...
sptr_t ScintillaEdit::countCharacters(sptr_t startPos, sptr_t endPos) {
...
void ScintillaEdit::setCurrentPos(sptr_t pos) {
    send(SCI_SETCURRENTPOS, pos, 0);
}

void ScintillaEdit::setSelectionStart(sptr_t pos) {
...
void ScintillaEdit::setSelectionEnd(sptr_t pos) {
...
void ScintillaEdit::setEmptySelection(sptr_t pos) {
...
void ScintillaEdit::setSel(sptr_t start, sptr_t end) {
...
void ScintillaEdit::setTargetStart(sptr_t pos) {
...
void ScintillaEdit::setTargetEnd(sptr_t pos) {
...
void ScintillaEdit::setSearchFlags(sptr_t flags) {
...
sptr_t ScintillaEdit::visibleFromDocLine(sptr_t line) {
    return send(SCI_VISIBLEFROMDOCLINE, line, 0);
}

sptr_t ScintillaEdit::docLineFromVisible(sptr_t lineDisplay) {
    return send(SCI_DOCLINEFROMVISIBLE, lineDisplay, 0);
}

sptr_t ScintillaEdit::wrapCount(sptr_t line) {
...
void ScintillaEdit::setWrapMode(sptr_t mode) {
...
void ScintillaEdit::setWrapIndentMode(sptr_t mode) {
...
void ScintillaEdit::setLayoutCache(sptr_t mode) {
...
void ScintillaEdit::setFirstVisibleLine(sptr_t lineDisplay) {
...
void ScintillaEdit::braceHighlight(sptr_t pos1, sptr_t pos2) {
    send(SCI_BRACEHIGHLIGHT, pos1, pos2);
}

void ScintillaEdit::braceHighlightIndicator(bool useBraceHighlightIndicator, sptr_t indicator) {
...
void ScintillaEdit::braceBadLightIndicator(bool useBraceBadLightIndicator, sptr_t indicator) {
    send(SCI_BRACEBADLIGHTINDICATOR, useBraceBadLightIndicator, indicator);
}

sptr_t ScintillaEdit::braceMatch(sptr_t pos) {
...
void ScintillaEdit::setDocPointer(sptr_t pointer) {
    send(SCI_SETDOCPOINTER, 0, pointer);
}

void ScintillaEdit::setModEventMask(sptr_t mask) {
...
void ScintillaEdit::setEdgeMode(sptr_t mode) {
...
sptr_t ScintillaEdit::searchNext(sptr_t flags, const char * text) {
    return send(SCI_SEARCHNEXT, flags, (sptr_t)text);
}

sptr_t ScintillaEdit::searchPrev(sptr_t flags, const char * text) {
...
void ScintillaEdit::setZoom(sptr_t zoom) {
...
void ScintillaEdit::setStatus(sptr_t statusCode) {
...
void ScintillaEdit::setXOffset(sptr_t newOffset) {
...
void ScintillaEdit::setPrintWrapMode(sptr_t mode) {
...
void ScintillaEdit::setSelectionMode(sptr_t mode) {
...
void ScintillaEdit::indicatorFillRange(sptr_t position, sptr_t fillLength) {
    send(SCI_INDICATORFILLRANGE, position, fillLength);
}

void ScintillaEdit::indicatorClearRange(sptr_t position, sptr_t clearLength) {
    send(SCI_INDICATORCLEARRANGE, position, clearLength);
}

sptr_t ScintillaEdit::indicatorAllOnFor(sptr_t position) {
    return send(SCI_INDICATORALLONFOR, position, 0);
}

sptr_t ScintillaEdit::indicatorValueAt(sptr_t indicator, sptr_t position) {
    return send(SCI_INDICATORVALUEAT, indicator, position);
}

sptr_t ScintillaEdit::indicatorStart(sptr_t indicator, sptr_t position) {
    return send(SCI_INDICATORSTART, indicator, position);
}

sptr_t ScintillaEdit::indicatorEnd(sptr_t indicator, sptr_t position) {
...
sptr_t ScintillaEdit::rangePointer(sptr_t position, sptr_t rangeLength) const {
...
sptr_t ScintillaEdit::setSelection(sptr_t caret, sptr_t anchor) {
...
void ScintillaEdit::setSelectionNCaret(sptr_t selection, sptr_t pos) {
...
void ScintillaEdit::setSelectionNAnchor(sptr_t selection, sptr_t posAnchor) {
...
void ScintillaEdit::setSelectionNStart(sptr_t selection, sptr_t pos) {
...
void ScintillaEdit::setSelectionNEnd(sptr_t selection, sptr_t pos) {
...
void ScintillaEdit::setRectangularSelectionCaret(sptr_t pos) {
...
void ScintillaEdit::setRectangularSelectionAnchor(sptr_t posAnchor) {
...
sptr_t ScintillaEdit::propertyInt(const char * key) const {
    return send(SCI_GETPROPERTYINT, (sptr_t)key, 0);
}
